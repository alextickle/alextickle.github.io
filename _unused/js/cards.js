var cards = ["2_of_clubs", "3_of_clubs", "4_of_clubs", "5_of_clubs", "6_of_clubs", "7_of_clubs", "8_of_clubs", "9_of_clubs", "10_of_clubs", "jack_of_clubs", "queen_of_clubs", "king_of_clubs", "ace_of_clubs",
...
$(document).ready(function(){
  $("#0").attr("src", "../media/cards/" + drawCard() + ".png");
  $("#1").attr("src", "../media/cards/" + drawCard() + ".png");
  $("#2").attr("src", "../media/cards/" + drawCard() + ".png");
  $("#3").attr("src", "../media/cards/" + drawCard() + ".png");
  $("#4").attr("src", "../media/cards/" + drawCard() + ".png");
});
